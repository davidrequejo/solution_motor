...
<head>
  ...
  <meta name="author" content="Libreria sistema">
  ...
  <meta name="twitter:title" content="Libreria sistema">
...
<body class="landing-body">
  ...
  <script src="assets/js/funcion_crud.js?version_jdl=1.16"></script>

  <script src="vistas/scripts/home.js?version_jdl=1.16"></script>
  <script src="scripts_client/login_cliente.js?version_jdl=1.16"></script>
