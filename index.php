<!DOCTYPE html>
<html lang="en" dir="ltr" data-nav-layout="horizontal" data-nav-style="menu-click" data-menu-position="fixed" data-theme-mode="light" style="--primary-rgb: 223, 90, 90;">
...
<body class="landing-body">
    ...
    <div class="offcanvas-body">
      ...
      <div class="theme-colors">
        ...
        <div class="d-flex align-items-center switcher-style">
          ...
          <div class="form-check switch-select me-3">
            <input class="form-check-input color-input color-primary-4" type="radio" name="theme-primary" id="switcher-primary3" checked>
          </div>
          <div class="form-check switch-select me-3">
  ...
  <div class="landing-page-wrapper">
      ...
      <div class="container-xl">
        ...
        <div class="main-sidebar">
          ...
          <nav class="main-menu-container nav nav-pills sub-open">
            ...
            <div class="slide-left" id="slide-left"><svg xmlns="https://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24">
            ...
            <ul class="main-menu">
              ...
              <li class="slide has-sub">
                ...
                <ul class="slide-menu child1">
                  ...
                  <li class="slide">
                    <a href="#team" class="side-menu__item">Equipo</a>
                  </li>
                </ul>
              </li>
              <!-- End::slide -->
              <!-- Start::slide -->
              <li class="slide">
                <a href="#libros" class="side-menu__item">
                  <span class="side-menu__label">Libros</span>
                </a>
              </li>
              <!-- End::slide -->
              <!-- Start::slide -->
              <li class="slide">
                <a href="#categorias-libros" class="side-menu__item">
                  <span class="side-menu__label">Categoría</span>
                </a>
              </li>
              <!-- End::slide -->
              <!-- Start::slide -->
            ...
            <div class="slide-right" id="slide-right">
              <svg xmlns="https://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24">
                <path d="M10.707 17.707 16.414 12l-5.707-5.707-1.414 1.414L13.586 12l-4.293 4.293z"></path>
              </svg>
            </div>
            <div class="d-lg-flex d-none">
              <div class="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                <a href="https://api.whatsapp.com/send?phone=+51921487276&text=*Hola buenos dias, vengo de tu pagina web!!*" class="btn btn-wave btn-primary"><i class="ti ti-brand-whatsapp"></i> Contactanos</a>
    ...
    <div class="main-content landing-main px-0">
          ...
          <div class="container main-banner-container pb-lg-0">
            <div class="row">
              <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                <div class="py-lg-5">
                  <div class="mb-3">
                    <h5 class="fw-semibold text-fixed-white op-9">Donde cada página es una oportunidad para aprender</h5>
                  </div>
                  <p class="landing-banner-heading mb-3">Explora libros y útiles escolares en <span class="text-secondary">Libreria sistema!</span></p>
                  <div class="fs-16 mb-5 text-fixed-white op-9">En Librería Sistema encuentras libros, cuadernos, mochilas y más. Todo lo que necesitas para tu aprendizaje, creatividad y éxito escolar en un solo lugar.</div>
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-4">
                <div class="text-end landing-main-image landing-heading-img">
                  <!-- <img src="assets/images/media/landing/lib_util.png" alt="img" class="img-fluid"> -->
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Start:: Section-2 -->
      <section class="section section-bg" id="categorias-libros">
        <div class="container text-center position-relative">
          <p class="fs-12 fw-semibold text-success mb-1"><span class="landing-section-heading">CATEGORÍAS</span></p>
          <h3 class="fw-semibold mb-2">Explora lo más buscado en Librería Sistema</h3>
          <div class="row justify-content-center">
            <div class="col-xl-7">
              <p class="text-muted fs-15 mb-5 fw-normal">
                Tenemos materiales para todos los gustos y necesidades: desde emocionantes novelas hasta libros escolares y cuadernos para tu día a día académico.
              </p>
            </div>
          </div>
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                  <div class="p-3 text-center rounded-2 bg-white border">
                    <span class="mb-3 avatar avatar-lg avatar-rounded bg-primary-transparent">
                      <i class='fs-24 bx bx-book-open'></i> <!-- Libros -->
                    </span>
                    <h5 class="fw-semibold mb-0 text-dark">Libros</h5>
                    <p class="mb-1 fs-14 op-7 text-muted">Historia, cultura, obras literarias</p>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                  <div class="p-3 text-center rounded-2 bg-white border">
                    <span class="mb-3 avatar avatar-lg avatar-rounded bg-primary-transparent">
                      <i class='fs-24 bx bx-palette'></i> <!-- Arte -->
                    </span>
                    <h5 class="fw-semibold mb-0 text-dark">Arte</h5>
                    <p class="mb-1 fs-14 op-7 text-muted">Acuarelas, pintura, pinceles</p>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                  <div class="p-3 text-center rounded-2 bg-white border">
                    <span class="mb-3 avatar avatar-lg avatar-rounded bg-primary-transparent">
                      <i class='fs-24 bx bx-calculator'></i> <!-- Matemática -->
                    </span>
                    <h5 class="fw-semibold mb-0 text-dark">Matemática</h5>
                    <p class="mb-1 fs-14 op-7 text-muted">Calculadoras, reglas, escuadras</p>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                  <div class="p-3 text-center rounded-2 bg-white border">
                    <span class="mb-3 avatar avatar-lg avatar-rounded bg-primary-transparent">
                      <i class='fs-24 bx bx-pen'></i> <!-- Caligrafía -->
                    </span>
                    <h5 class="fw-semibold mb-0 text-dark">Caligrafía</h5>
                    <p class="mb-1 fs-14 op-7 text-muted">Recursos para mejorar</p>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                  <div class="p-3 text-center rounded-2 bg-white border">
                    <span class="mb-3 avatar avatar-lg avatar-rounded bg-primary-transparent">
                      <i class='fs-24 bx bx-pencil'></i> <!-- Material Escolar -->
                    </span>
                    <h5 class="fw-semibold mb-0 text-dark">Material Escolar</h5>
                    <p class="mb-1 fs-14 op-7 text-muted">Cuadernos, lápices y más</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="section" id="about">
        <div class="container text-center">
          <p class="fs-12 fw-semibold text-success mb-1">
            <span class="landing-section-heading">NOSOTROS</span>
          </p>
          <h3 class="fw-semibold mb-2">Impulsamos tu educación con libros y útiles escolares</h3>
          <div class="row justify-content-center">
            <div class="col-xl-7">
              <p class="text-muted fs-15 mb-3 fw-normal">
                En Librería Sistema creemos que el aprendizaje comienza con las herramientas adecuadas. Por eso, ofrecemos una amplia variedad de libros y útiles escolares para cada etapa de tu formación académica.
              </p>
            </div>
          </div>
          <div class="row justify-content-between align-items-center mx-0">
            <div class="col-xxl-6 col-xl-5 col-lg-5 text-center">
              <div class="text-lg-end">
                <img src="assets/images/media/landing/mj-lib2.webp" alt="Imagen de la librería" class="img-fluid">
              </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 pt-2 pb-0 px-lg-2 px-5 text-start">
              <h5 class="text-lg-start fw-semibold mb-0">Tu aliado en el camino del conocimiento</h5>
              <p class="text-muted">
                Brindamos una experiencia completa para estudiantes, padres y docentes, combinando recursos educativos de calidad con atención especializada.
              </p>
              <div class="row">
                <div class="col-12 col-md-12">
                  <div class="d-flex">
                    <span>
                      <i class='bx bxs-book-content text-primary fs-18'></i>
                    </span>
                    <div class="ms-2">
                      <h6 class="fw-semibold mb-0">Variedad en libros y útiles</h6>
                      <p class="text-muted">
                        Nuestro catálogo incluye textos escolares, literatura infantil y juvenil, cuadernos, lápices, mochilas y todo lo necesario para el estudio. Actualizamos nuestros productos constantemente para estar al día con el calendario escolar y académico.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-12">
                  <div class="d-flex">
                    <span>
                      <i class='bx bxs-truck text-primary fs-18'></i>
                    </span>
                    <div class="ms-2">
                      <h6 class="fw-semibold mb-0">Envíos seguros</h6>
                      <p class="text-muted">
                        Realizamos entregas rápidas y confiables para que no te falte nada en el regreso a clases o en tus jornadas de estudio. Cada pedido es empacado con cuidado para proteger el contenido durante el traslado.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-12">
                  <div class="d-flex">
                    <span>
                      <i class='bx bxs-heart text-primary fs-18'></i>
                    </span>
                    <div class="ms-2">
                      <h6 class="fw-semibold mb-0">Atención cercana y dedicada</h6>
                      <p class="text-muted">
                        Nuestro equipo está preparado para orientarte en la elección de materiales según tu nivel educativo o el de tus hijos. Te ayudamos a encontrar exactamente lo que necesitas para que estudiar sea más fácil y efectivo.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section class="section section-bg" id="our-mission">
        <div class="container text-center">
          <p class="fs-12 fw-semibold text-success mb-1">
            <span class="landing-section-heading">NUESTRA MISIÓN</span>
          </p>
          <h2 class="fw-semibold mb-2">Nos guiamos por 8 pilares que definen nuestro compromiso</h2>
          <div class="row justify-content-center mb-5">
            <div class="col-xl-7">
              <p class="text-muted fs-15 mb-0 fw-normal">
                En Librería Sistema, promovemos la lectura con una experiencia personalizada, accesible y en constante evolución, alineada a las necesidades de nuestros lectores.
              </p>
            </div>
          </div>
          <div class="row">
                ...
                <div class="card-body">
                  <div class="mb-2">
                    <span class="avatar avatar-lg avatar-rounded bg-primary-transparent">
                      <i class='bx bx-book-reader fs-25'></i>
                    </span>
                  </div>
                  <h6 class="fw-semibold mb-1">Calidad Editorial</h6>
                  <p class="mb-0 text-muted">Seleccionamos títulos de autoría reconocida y editoriales destacadas para asegurar contenidos de valor.</p>
                </div>
              </div>
            </div>
            <!-- Pilar 2 -->
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card custom-card text-start landing-missions">
                <div class="card-body">
                  ...
                  <h6 class="fw-semibold mb-1">Contenido Enriquecido</h6>
                  <p class="mb-0 text-muted">Acompañamos cada libro con reseñas, sinopsis detalladas y recursos complementarios para profundizar tu aprendizaje.</p>
                </div>
              </div>
            </div>
            <!-- Pilar 3 -->
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card custom-card text-start landing-missions">
                <div class="card-body">
                  ...
                  <h6 class="fw-semibold mb-1">Recomendaciones a tu medida</h6>
                  <p class="mb-0 text-muted">Te sugerimos libros alineados a tus intereses, nivel académico y estilo de lectura.</p>
                </div>
              </div>
            </div>
            <!-- Pilar 4 -->
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card custom-card text-start landing-missions">
                <div class="card-body">
                  ...
                  <h6 class="fw-semibold mb-1">Novedades siempre al día</h6>
                  <p class="mb-0 text-muted">Nuestro catálogo se renueva constantemente con las últimas publicaciones y tendencias editoriales.</p>
                </div>
              </div>
            </div>
            <!-- Pilar 5 -->
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card custom-card text-start landing-missions">
                <div class="card-body">
                  ...
                  <h6 class="fw-semibold mb-1">Soporte inmediato</h6>
                  <p class="mb-0 text-muted">Atención ágil para responder tus consultas, gestionar pedidos o brindarte asesoría lectora, las 24 horas.</p>
                </div>
              </div>
            </div>
            <!-- Pilar 6 -->
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card custom-card text-start landing-missions">
                <div class="card-body">
                  ...
                  <h6 class="fw-semibold mb-1">Estética funcional</h6>
                  <p class="mb-0 text-muted">Diseñamos una plataforma visualmente agradable que hace que comprar y explorar libros sea sencillo y placentero.</p>
                </div>
              </div>
            </div>
            <!-- Pilar 7 -->
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card custom-card text-start landing-missions">
                <div class="card-body">
                  ...
                  <h6 class="fw-semibold mb-1">Lectura sin límites</h6>
                  <p class="mb-0 text-muted">Navega cómodamente desde cualquier dispositivo: teléfono, tablet o computadora.</p>
                </div>
              </div>
            </div>
            <!-- Pilar 8 -->
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card custom-card text-start landing-missions">
                <div class="card-body">
                  ...
                  <h6 class="fw-semibold mb-1">Diseño adaptable</h6>
                  <p class="mb-0 text-muted">Nuestra web se ajusta automáticamente a cualquier resolución para una experiencia fluida y sin interrupciones.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Start:: Section-5 -->
      <section class="section landing-Features" id="libros">
        <div class="container text-center">
          <p class="fs-12 fw-semibold text-success mb-1">
            <span class="landing-section-heading">LIBROS</span>
          </p>
          <h2 class="fw-semibold mb-2 text-fixed-white">Catálogo de Libros a tu disposicón</h2>
          <div class="row justify-content-center">
            <div class="col-xl-7">
              <p class="text-fixed-white op-8 fs-15 mb-3 fw-normal">
                Nuestra plataforma está diseñada para ofrecerte una experiencia de lectura eficiente, personalizada y enriquecedora.
              </p>
            </div>
          </div>
              ...
              <div class="">
                <div class="feature-logos mt-sm-5 flex-wrap">
                  <div class="ms-sm-5 ms-2 text-center">
                    <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary op-7" style="width: 60px; height: 60px;">
                      <i class="fs-3 bx bx-book-heart text-white"></i>
                    </div>
                    <h5 class="mt-3 text-fixed-white">Romance</h5>
                  </div>
                  <div class="ms-sm-5 ms-2 text-center">
                    <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary op-7" style="width: 60px; height: 60px;">
                      <i class='fs-30 bx bx-ghost text-white'></i>
                    </div>
                    <h5 class="mt-3 text-fixed-white">Misterio</h5>
                  </div>
                  <div class="ms-sm-5 ms-2 text-center">
                    <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary op-7" style="width: 60px; height: 60px;">
                      <i class='fs-30 bx bx-history text-white'></i>
                    </div>
                    <h5 class="mt-3 text-fixed-white">Historia</h5>
                  </div>
                  <div class="ms-sm-5 ms-2 text-center">
                    <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary op-7" style="width: 60px; height: 60px;">
                      <i class='fs-30 bx bx-planet text-white'></i>
                    </div>
                    <h5 class="mt-3 text-fixed-white">Ciencia Ficción</h5>
                  </div>
                  <div class="ms-sm-5 ms-2 text-center">
                    <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary op-7" style="width: 60px; height: 60px;">
                      <i class='fs-30 bx bx-edit text-white'></i>
                    </div>
                    <h5 class="mt-3 text-fixed-white">Obras Literarias</h5>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
              <div class="px-4">
                <p class="fw-semibold mb-3"><a href="index.html"><img src="assets/images/brand-logos/desktop-dark.png" alt="" width="100%"></a></p>
                <p class="mb-2 op-6 fw-normal">
                  Tu tienda de snacks favoritos.
                  Ofrecemos una variedad de deliciosos y frescos snacks para todos los gustos. ¡Descubre nuestros productos y disfruta del sabor en cada bocado!
                </p>
                <p class="mb-0 op-6 fw-normal">el lugar donde la calidad y el sabor se encuentran.</p>
              </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12">
              <div class="px-4">
                ...
                <ul class="list-unstyled fw-normal landing-footer-list">
                  ...
                  <li>
                    <a href="javascript:void(0);" class="text-fixed-white op-6"><i class="ri-mail-line me-1 align-middle"></i> novedadesdys@gmail.com</a>
                  </li>
                  <li>
      ...
      <div class="text-center landing-main-footer py-3">
        <span class="text-muted fs-15"> Copyright © <span id="year"></span>
          <a href="javascript:void(0);" class="text-primary fw-semibold"><u>Libreria sistema</u></a>.
