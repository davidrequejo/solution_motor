    ...
    ?>
      ...
      <html lang="es" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="icon-overlay-close" data-bg-img="bgimg4" style="--primary-rgb: 208, 2, 149;" loader="enable">
        ...
        <body id="body-gastos-trab">
                          ...
                          <div id="div-formulario" style="display: none;">
                            <form name="formulario-gasto" id="formulario-gasto" method="POST" class="row g-3 needs-validation" novalidate>
                              ...
                              <div class="row gy-2" id="cargando-1-formulario">
                                ...
                                <input type="hidden" name="tipo_gasto_modulo" id="tipo_gasto_modulo" value="GASTOS"/>
                      ...
                      <form name="form-agregar-categoria-otros-gastos" id="form-agregar-categoria-otros-gastos" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row" id="cargando-5-fomulario">
                          ...
                          <div class="mb-1 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                            <div class="form-group">
                              <label for="nombre_ie_cat" class="form-label">Nombres </label>
                          ...
                          <div class="mb-1 col-md-12 col-lg-12 col-xl-12 col-xxl-12 ">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="descr_ie_cat" id="descr_ie_cat" rows="2" onkeyup="mayus(this);"></textarea>
                            </div>                                         
                          </div>
          ...
          <script src="scripts/otros_gastos.js?version_jdl=1.16"></script>
