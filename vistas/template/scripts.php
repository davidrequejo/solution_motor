...
<script type="text/javascript" src="../assets/js/funcion_general.js?version_jdl=1.16"></script>

<!-- Data Table -->
<script src="../assets/libs/data-table/datatables.js"></script>
<!-- <script src="../assets/libs/data-table/colResize-1.7.2/jquery.dataTables.colResize.js"></script> -->
